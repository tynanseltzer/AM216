...
import numpy as np
top = [1610612744, 1610612745, 1610612739, 1610612746, 1610612762, 1610612761, 1610612759, 1610612756, 1610612740,
    1610612741, 1610612757, 1610612742, 1610612760, 1610612737, 1610612763]
for i in range(1,1231):
    print (i)
    # Generate games, they are 0001 to 1230
    path = '/Users/tynanseltzer/ap216/project/pisceff14/'
    gamestr = '002140'
    ...
    for an_id in homeIds:
        shot_df = ShotChart(player_id=an_id, game_id = gamestr, season='2014-15')
