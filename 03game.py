...
import numpy as np
inp = int(input("yo yo yo"))
for i in range(inp,1231):
    # Generate games, they are 0001 to 1230
    print ("ITERS", i)
    path = '/Users/tynanseltzer/ap216/project/pics/03/'
    gamestr = '002030'
    ...
    appended_data = []
    for an_id in ids:
        shot_df = ShotChart(player_id=an_id, game_id = gamestr, season='2003-04')
